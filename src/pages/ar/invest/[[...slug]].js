...
const Invest = () => {
    ...
    const drone = [
        "السرعة التقديرية لتوبان 1000 هي 850 كم / ساعة",
        "الحمولة القصوى 600 كجم",
        "المدى 1200 كيلومتر"
    ]

    const real = [
        "ترميز العقارات من النمسا",
        "نقل سهل وسريع عبر blockchain",
        "رسوم دخول منخفضة",
        "المشاركة في الربح"
    ]

    const tupanP = [
        "الاقتصاد القائم على التجديد المستدام",
        "صدر من خلال زراعة شبيهة بالزراعة الطبيعية التي تنتقل من البذرة إلى الفاكهة",
        "المزايا المقدمة من ZENIQ Blockchain",
        "مرتبطة بالنظام البيئي الحقيقي لمنطقة الأمازون"
    ]

    return (
        <main>
            <header ref={hero} class="smInvest md:mdInvest">
                <div dir="rtl" className={` top-[34.05797101449276vw] mx-auto relative col items-center text-center md:text-start md:items-start gap-[0.5256vw] md:absolute md:top-[14.25755584756899vw] md:left-[18.725361366622863vw] z-[1]`} >
                    ...
                    <p class={`heroDescriptionAR hiddenDown ${heroVisible ? 'showY delay-300' : ''}`}>
                        استثمر في المشاريع التي تم إنشاؤها حول النظام البيئي الذي توفره سفير زينيك
                    </p>
                </div>
            ...
            <div class="invest" >
                <section id="Latest" class="w-full col gap-[7vw] md:gap-[5.256241787122208vw] ">
                    ...
                    </h2>
                    {
                        ytb ?
                            ...
                            <div class="latest bg-[url('https://Image.youtube.com/vi/HcFNAwxVc1g/maxresdefault.jpg')] cursor-pointer" onClick={() => setYtb(!ytb)}>
                    ...
                    <div ref={tdroneR} id="Tdrone" class={`col items-center mt-[13.043478260869565vw] md:items-start md:section md:mt-[4.270696452036794vw] `}>
                        <div dir="rtl" class={`col ${viewPort ? 'hiddenDown' : ''} md:hiddenRight ${tdroneVisible && viewPort ? 'showY' : ''} ${tdroneVisible ? 'md:showX' : ''} `}>
                            <h2 class="titleAR">
                                TDRONE
                            </h2>
                            <p class="paragraph text-start mt-[7.246376811594203vw] md:mt-[2.3653088042049935vw]">
                                Tupan Aircraft هي شركة إقلاع وهبوط عمودية كهربائية هجينة (VTOL) وإقلاع وهبوط عمودي كهربائي (eVTOL) أسسها مجموعة من المهندسين البرازيليين الذين يتمتعون بسنوات من الخبرة في تصميم نظام الدفع واختبار الطيران والديناميكا الهوائية والتحكم الذاتي رحلة جوية.
                                واليوم يمكنك الاستثمار في هذا الأخير الواعد عن طريق TDRONE Masternode لصك الرمز.
                            </p>
                ...
                <section ref={tupan} id="Tupan Token" class="col flex-col-reverse items-center md:section">
                    ...
                    <div dir="rtl" class={`col ${viewPort ? 'hiddenDown' : ''} md:hiddenRight ${tupanVisible && viewPort ? 'showY' : ''} ${tupanVisible ? 'md:showX' : ''} `}>
                        <h2 class="titleAR">
                            Tupan Token
                        </h2>
                        <p class="paragraph text-start mt-[10.38647342995169vw] md:mt-[2.3653088042049935vw]">
                            TCT أو Tupan Community Token هو أساس مشروع Tupan القائم على سلسلة ZENIQ blockchain ، لبناء عالم اقتصادي أفضل من خلال الإجراءات الإيجابية تجاه بيئتنا.
                        </p>
                        ...
                        <p class="paragraph text-start mt-[10.38647342995169vw] md:mt-[2.3653088042049935vw]">
                            للمزيد من المعلومات  <a href='https://www.tupan.io' target='_blank' rel="noreferrer"><strong>tupan.io </strong></a>
                        </p>
                    </div>
                </section>
                <section id="Sidi" class="w-full col md:gap-[8.21287779237845vw] ">
                    <div ref={sidiIm} class="sidiIm bg-[url('../../public/Invest/sidiIm.jpg')]" >
                        ...
                        <div dir="rtl" class="absolute w-[50%] h-full right-0 bg-[rgba(223,223,223,0.51)]">
                            <div class=" mr-[4vw] mt-[28vw] md:mr-[10vw] md:mt-[17vw] md:w-[18.068331143232587vw]">
                                <h3 class={`smallTitleAR text-newBlack ml-[1.2vw] md:ml-[0.657030223390276vw] hiddenDown ${sidiImVisible ? 'showY' : ''} `} >
                                    العقارات
                                </h3>
                                <h1 class={` mt-[4vw] md:mt-0 text-[11vw] leading-[13vw] text-white md:bigTitleAR hiddenDown ${sidiImVisible ? 'showY delay-200' : ''}`}>
                                    المرمزة
                                </h1>
                            </div>
                        </div>
                    ...
                    <div ref={sidiToken} id="Sidi Token" class="mt-[13.043478260869565vw] md:mt-0 col items-center md:row md:gap-[9.85545335085414vw]">
                        <div dir="rtl" class={`col ${viewPort ? 'hiddenDown' : ''} md:hiddenRight ${sidiVisible && viewPort ? 'showY' : ''} ${sidiVisible ? 'md:showX' : ''} `}>
                            <h2 class="titleAR">
                                SIDI TOKEN
                            </h2>
                            <p class="paragraph text-start mt-[10.38647342995169vw] md:mt-[2.3653088042049935vw]">
                                رمز SIDI هو رمز عقاري مرتبط بحق المشاركة في مادة لشركة SIDO Immobilien GmbH. استنادًا إلى ZENIQ Blockchain. يشارك مالكو الرمز المميز في أرباح SIDO Immobilien GmbH من خلال حق المشاركة.
                            </p>
                            <ul class="ul mt-[13.043478260869565vw] md:mt-[3.5479632063074904vw]">
                                {real.map((key, i) => {
                                    return (
                            ...
                            <p class="paragraph text-start mt-[10.38647342995169vw] md:mt-[2.3653088042049935vw]">
                                للمزيد من المعلومات <a href='https://sido-immobilien.at/' target='_blank' rel="noreferrer"><strong>sido-immobilien.at</strong></a>
                            </p>
                        </div>
                ...
                <section ref={reg} id="Regardless" class="col items-center md:section">
                    <div dir="rtl" class={`col ${viewPort ? 'hiddenDown' : ''} md:hiddenRight ${regVisible && viewPort ? 'showY' : ''} ${regVisible ? 'md:showX' : ''} `}>
                        <h2 class="titleAR">
                            Regardless
                        </h2>
                        <p class="paragraph text-start mt-[10.38647342995169vw] md:mt-[2.3653088042049935vw]">
                            نقدم مشروع الترميز السينمائي المبتكر: REGARDLESS. يتعلق الأمر بترميز فيلم "Regardless" ، والذي سيتم إصداره ورمزه على سلسلة ZENIQ الذكية بفضل تقنية ZENIQ الثورية. إنها حداثة ترميز فيلم كامل.
                            <br />
                            لذلك لا تضيع أي وقت وابدأ في سك العملة المميزة بغض النظر عن ذلك.
                        </p>
                    </div>
                    <div class="mt-[13.043478260869565vw] md:mt-0" >
