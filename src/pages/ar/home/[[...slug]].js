...
const Home = () => {
    ...
    // ?text=مرحبا%20أود%20معرفة%20المزيد%20حول%20مشروع%20زينيك%20و%20عملة%20زينيك
    ...
    const keys = [
        "شراكة سمو الشيخ سعيد بن حشر آل مكتوم.",
        "شراكات مع شركات عالمية قوية مثل: Avinoc و Tupan.",
        "تم إدراج عملة ZENIQ بالفعل في CoinMarketCap و Uniswap و PANCAKESWAP وقريبًا على Binance.",
        "خلف Blockchain Solana مباشرة ،تأتي Blockchain زينيك في المرتبة الثانية بسرعة معاملة تبلغ 50000 معاملة/ثانية، كل هذا مع كونها لا مركزية بالكامل.",
        "نظام معلوماتي رقمي قوي ومتكامل."
    ]
    ...
    useEffect(() => {
        const interval = setInterval(() => {
            if (currentIndex === 8) {
                ...
                setTimeout(() => {
                    sources.current.style.transform = `translate(-${currentLeft}vw)`;
                    sources.current.style.transition = `all 2s`
                }, 0)

            }
            else {
                setLeft(prev => prev + currentLeft)
                sources.current.style.transform = `translate(-${left + currentLeft}vw)`;
    ...
    return (
        <main>
            <header ref={hero} class="smBg md:mdBg ">
                <div dir="rtl" className="top-[34.05797101449276vw] mx-auto relative md:absolute md:top-[16.688vw] md:left-[7.2273vw] col items-center text-center md:text-start md:items-start gap-[0.5256vw] " >
                    <h3 class={`ml-[0.2628vw] smallTitleAR hiddenDown ${heroVisible ? 'showY' : ''}`} >
                        ترميز
                    </h3>
                    <h1 class={`first-letter bigTitleAR hiddenDown ${heroVisible ? 'showY delay-200' : ''}`}>
                        المستقبل
                    </h1>
                    <p class={`heroDescriptionAR mt-[0.1314060446780552vw] hiddenDown ${heroVisible ? 'showY delay-300' : ''}`}>
                        بناء نظام مالي حديث باستخدام سلسلة <br />
                        Zeniq Blockchain
                    </p>
                    <a href="https://safir.com/backoffice/ref/p2khytgzn2" target="_blank" class={`joinBtnAR hiddenDown ${heroVisible ? 'showY' : ''}`} rel="noreferrer">
                        انظم الٱن
                    </a>
                </div>
                <Image class={` mt-[53vw] mx-auto relative md:mt-0 md:absolute md:top-[7.687253613666228vw] md:left-[44.021024967148485vw] homePic `} src={home} alt="home" />
            ...
            <div class="home" >
                <a href="https://safir.com/backoffice/ref/p2khytgzn2" target="_blank" class={` joinBtnAR fixed duration-[400ms] m-0 ${showButton ? 'opacity-100 h-auto ' : 'duration-[400ms] opacity-0 invisible'} bottom-4 right-[29.468599033816425vw] md:right-8 `} rel="noreferrer" >
                    انظم الٱن
                </a>
                <section id="Trusted By" class="col items-cente ">
                    <h2 class="titleAR text-center">
                        موثوق من طرف
                    </h2>
                    <div class="trusted">
                ...
                <section id="About Zeniq" class="md:col items-center ">
                    <div ref={about} id="About" class="col gap-[14.000000000000002vw] md:row md:items-start md:gap-[6.5703vw] " >
                        ...
                        <div class={`col gap-[9vw] md:gap-[1.5768725361366622vw] md:mt-[2.299605781865966vw] ${(currentLeft === smLeft) ? 'hiddenDown' : ''} md:hiddenRight ${(aboutIsVisible && (currentLeft === smLeft)) ? 'showY' : ''} ${aboutIsVisible ? 'md:showX' : ''}`} >
                            <h2 class="titleAR">
                                عن زينيك سفير
                            </h2>
                            <div class="col gap-[5.797101449275362vw] md:gap-[1.5768725361366622vw]" >
                                <p dir="rtl" class="paragraph">
                                    تعتبر ZENIQ ، التي يقع مقرها في مركز دبي المالي العالمي (DIFC) ، رائدة في السوق العالمية لإدارة الأصول الرقمية الآمنة وسهلة الاستخدام بنسبة 100٪ للمستخدمين والمستثمرين والمبتكرين.                                </p>
                                <p dir="rtl" class="paragraph">
                                    تهدف ZENIQ إلى أن تصبح بوابة للاستثمارات الرقمية في غضون سنوات قليلة وستكون واحدة من أفضل البورصات في العالم مع التبادلات اللامركزية من خلال blockchain القوية والسريعة.                                </p>
                            </div>
                        </div>
                    </div>
                    <div ref={bulletPoints} id="Bullet Points" class="bulletList ">
                        <div class={`bulletPoint hiddenDown ${pointsAreVisible ? 'showY' : ''}`} >
                            ...
                            <div class="col w-[63.18115942028986vw] md:w-auto  items-center" >
                                <h3 class="bulletTitleAR" >
                                    تكنولوجيا الطاقة
                                </h3>
                                <p class="bulletText" >
                                    منتجات أصلية تجعل حياتك أسهل
                                </p>
                            </div>
                        </div>
                        <div class={`bulletPoint hiddenDown ${pointsAreVisible ? 'showY' : ''}`} >
                            ...
                            <div class="col w-[63.18115942028986vw] md:w-auto  items-center" >
                                ...
                                <p class="bulletText" >
                                    حيث يجب أن تكون الصحة "الحالة الطبيعية"
                                </p>
                            </div>
                        </div>
                        <div class={`bulletPoint hiddenDown ${pointsAreVisible ? 'showY' : ''}`} >
                            ...
                            <div class="col w-[63.18115942028986vw] md:w-auto  items-center" >
                                <h3 dir="rtl" class="bulletTitleAR" >
                                    تكنولوجيا blockchain
                                </h3>
                                <p dir="rtl" class="bulletText" >
                                    Blockchain ستغير حياتنا بشكل مستدام
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <section ref={zenSuccess} id="Zeniq Success" class="col">
                    ...
                    <div class={`successBulletPoints`}>
                        <ul dir="rtl" class={`col success text text-start ${(currentLeft === smLeft) ? 'hiddenDown' : ''} md:hiddenRight ${(successPointsAreVisible && (currentLeft === smLeft)) ? 'showY' : ''} ${successPointsAreVisible ? 'md:showX' : ''} `}>
                            {keys.map((text, i) => {
                ...
                <section id="Zeniq Hub" class="col gap-[7.487922705314009vw] md:gap-0">
                    <h2 class="titleAR text-center">
                        ZENIQ Hub
                    </h2>
                    <div ref={zHub} class="col md:row gap-[15.458937198067632vw] mt-[7.487922705314009vw] md:gap-[3.81077vw] md:mt-[4.20499vw]" >
                        ...
                        <div dir="rtl" class={`md:pt-[1.5168vw ${(currentLeft === smLeft) ? 'hiddenDown' : ''} md:hiddenRight ${(zHubVisible && (currentLeft === smLeft)) ? 'showY' : ''} ${zHubVisible ? 'md:showX' : ''}`} >
                            <p class="paragraph">
                                ZENIQ Hub هو الجيل التالي من محفظة الأجهزة التي تحمي الأصول الرقمية للمستخدم من خلال مكون الأمان المدمج. يتم تخزين الأصول الرقمية بشكل آمن ويمكن الوصول إليها في أي وقت من خلال تطبيق الهاتف المحمول ZENIQ.                                  </p>
                            <p class="paragraph font-bold mt-[15.458937198067632vw] md:mt-[3.81077vw]">
                                ولكن الأهم من ذلك ، أنه مفتاح الانظمام الخاص بك!
                                <br /><br />
                                لكي تكون جزءًا من ثورة قادمة في إدارة الأصول والتمويل.
                            </p>
                        </div>
                    </div>
                    <div class="mt-[11.83574879227053vw] md:mt-[6.5703vw] col items-center " >
                        <h2 class="titleAR text-center">
                            دخل سلبي و تدريجي
                        </h2>
                        <p dir="rtl" class="paragraph mt-[9.66183574879227vw] w-full md:w-[45.992vw] md:mt-[2.6281vw] text-center">
                            كل يوم ، ستربحك HUBs الخاصة بك عملات ZENIQ (ما بين 2 و 4 لكل HUB)، ولكن يمكنك الحصول على المزيد.
                        </p>
                    </div>
                    <div class="mt-[11.83574879227053vw] md:mt-[6.5703vw] col items-center " >
                        <h2 dir="rtl" class="titleAR font-normal text-center">
                            تتبع سعر عملة ZENIQ
                        </h2>
                    ...
                    <div ref={bitcoin} dir="rtl" class="flex-none mt-[13.9290407vw] md:pr-[3.35085vw] col" >
                        <h2 class={`titleAR text-start font-normal hiddenDown ${bitZenVisible ? 'showY' : ''}`}>
                            فاتك بيتكوين ...
                        </h2>
                        <h2 class={`text-start mt-[21.980676328502415vw] md:mt-[13.9290407vw] titleAR font-normal hiddenDown ${bitZenVisible ? 'showY delay-200' : ''}`}>
                            لا تفعل الشيء نفسه مع ZENIQ.
                        </h2>
                    </div>
                </section>
                <section ref={me} id="About Me" class="col items-center mt-[4.40210249vw]">
                    ...
                    <div class="col flex-col-reverse md:row gap-[6.5703vw] mt-[9.66183574879227vw] md:mt-[3.67936925vw] " >
                        <div class={`col ${(currentLeft === smLeft) ? 'hiddenDown' : ''} md:hiddenRight ${(meVisible && (currentLeft === smLeft)) ? 'showY' : ''} ${meVisible ? 'md:showX' : ''} pt-[10.628019323671497vw] md:pt-[2.89093298292vw]`} >
                            <h3 dir="rtl" class="bulletTitleAR text-center md:text-start font-medium" >
                                مرحبًا! اسمي زايد فاطمة
                            </h3>
                            <p dir="rtl" class="text w-full md:w-[42.772667vw] mt-[7.729468599033816vw] md:mt-[2.3653088042049935vw] ">
                                أنا من الجزائر، بالضبط من تيارت أين ترعرعت، حتى نهاية عام 1999، في ذلك العام غادرت الجزائر وذهبت للاستقرار في فرنسا، في مدينة Toulouse.
                                <br /><br />
                ...
                <section ref={social} id="Contact" class="col items-center md:gap-[6.57030223390276vw] gap-[15.458937198067632vw]">
                    ...
                    <div class={`row md:gap-[13.14060446780552vw] flex-wrap gap-[15.458937198067632vw] md:h-auto h-[42.7536231884058vw] w-[42.51207729468599vw] md:w-auto justify-between`}>
                        ...
                        <a href='https://wa.me/33771240382?text=مرحبا%20أود%20معرفة%20المزيد%20حول%20مشروع%20زينيك%20و%20عملة%20زينيك' target='_blank' rel="noreferrer" id="whatsapp" >
                        ...
                        <a id="telegram" href="https://t.me/+33771240382?text=مرحبا%20أود%20معرفة%20المزيد%20حول%20مشروع%20زينيك%20و%20عملة%20زينيك" >
