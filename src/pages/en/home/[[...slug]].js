...
const Home = () => {
    ...
    const keys = [
        "Partnership of His Highness Sheikh Saeed bin Hasher Al Maktoum.",
        "Partnerships with strong international companies such as: Avinoc and Tupan.",
        "ZENIQ COIN is already listed on CoinMarketCap, Uniswap, and PANCAKESWAP, and soon on Binance.",
        "Just behind the Solana Blockchain, ZENIQ Blockchain comes up second with a transaction speed of 50 000 T/S, while being fully decentralized.",
        "A robust and integrated digital ecosystem."
    ]
        ...
        <main>
            <header ref={hero} class="smBg md:mdBg ">
                <div className="top-[34.05797101449276vw] mx-auto relative md:absolute md:top-[16.688vw] md:left-[7.2273vw] col items-center text-center md:text-start md:items-start gap-[0.5256vw] " >
                    <h3 class={`ml-[0.2628vw] smallTitle hiddenDown ${heroVisible ? 'showY' : ''} `} >
                        Tokenizing the
                    </h3>
                    ...
                    <p class={`heroDescription hiddenDown ${heroVisible ? 'showY delay-300' : ''}`}>
                        Building a modern financial ecosystem using the ZENIQ blockchain.
                    </p>
                    <a href="https://safir.com/backoffice/ref/p2khytgzn2" target="_blank" class={`joinBtn hiddenDown ${heroVisible ? 'showY' : ''}`} rel="noreferrer" >
                        Join us
                    </a>
                </div>
            ...
            <div class="home" >
                    ...
                    <div ref={about} id="About" class="col gap-[14.000000000000002vw] md:row md:gap-[6.5703vw] items-center">
                        ...
                        <div class={`col gap-[9vw] md:gap-[2.2339vw] ${(currentLeft === smLeft) ? 'hiddenDown' : ''} md:hiddenRight ${(aboutIsVisible && (currentLeft === smLeft)) ? 'showY' : ''} ${aboutIsVisible ? 'md:showX' : ''}`} >
                            ...
                            <div class="col gap-[5.797101449275362vw] md:gap-[1.5768725361366622vw] ">
                                ...
                                <p class="paragraph">
                                    ZENIQ aims to become a portal for digital investments in a few years and will be one of the best exchanges in the world with decentralized exchanges by its powerful and fast blockchain.
                                </p>
                            </div>
                        </div>
                    </div>
                    <div ref={bulletPoints} id="Bullet Points" class={`bulletList `}>
                        <div class={`bulletPoint hiddenDown ${pointsAreVisible ? 'showY' : ''}`} >
                            ...
                            <div class="col w-[63.18115942028986vw] md:w-auto items-center" >
                                ...
                                <p class="bulletText" >
                                    Innovative Products that make your life easier
                                </p>
                            </div>
                        </div>
                        <div class={`bulletPoint hiddenDown ${pointsAreVisible ? 'showY delay-200' : ''}`} >
                            ...
                            <div class="col w-[63.18115942028986vw] md:w-auto items-center" >
                                ...
                                <p class="bulletText" >
                                    As Health should be the “normal state”
                                </p>
                            </div>
                        </div>
                        <div class={`bulletPoint hiddenDown ${pointsAreVisible ? 'showY delay-[400ms]' : ''}`} >
                            ...
                            <div class="col w-[63.18115942028986vw] md:w-auto items-center" >
                                ...
                                <p class="bulletText" >
                                    Blockchain will change our lives sustainably
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <section id="Zeniq Hub" class="col gap-[19.32367149758454vw] md:gap-0">
                        ...
                        <div ref={zHub} class="col md:row gap-[15.458937198067632vw] mt-[9.66183574879227vw] md:gap-[3.81077vw] md:mt-[4.20499vw]" >
                            ...
                            <div class={`md:pt-[1.5168vw ${(currentLeft === smLeft) ? 'hiddenDown' : ''} md:hiddenRight ${(zHubVisible && (currentLeft === smLeft)) ? 'showY' : ''} ${zHubVisible ? 'md:showX' : ''}`} >
                                <p class="paragraph text-start">
                                    The ZENIQ Hub is the next-generation hardware wallet providing protection for the user’s digital assets with its built-in security component. Digital assets are stored securely and can be accessed any time through the ZENIQ mobile application.                            </p>
                                <p class="paragraph text-start font-bold mt-[15.458937198067632vw] md:mt-[3.81077vw]">
                                    But most importantly, it's your access key!
                                    <br /><br />
                                    To be part of an upcoming revolution in asset management and finance.
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="md:mt-[6.5703vw] col items-center " >
                        <h2 class="title text-center">
                            Passive and Progressive Income
                        </h2>
                        <p class="paragraph mt-[9.66183574879227vw] w-full md:w-[45.992vw] md:mt-[2.6281vw] text-center">
                            Every day, your HUBs will earn you ZENIQ coins (between 2 and 4 per HUB), but you can get much more.
                        </p>
                    </div>
                    <div class="mt-[6.5703vw] col items-center " >
                        ...
                        <div className="coinMarketCap">
                            <div class="coinmarketcap-currency-widget" data-currencyid="23027" data-base="USD" data-secondary="" data-ticker="false" data-rank="true" data-marketcap="false" data-volume="true" data-statsticker="false" data-stats="USD"></div>
                        </div>
                    </div>
                    ...
                    <div class="col flex-col-reverse md:row gap-[6.5703vw] mt-[9.66183574879227vw] md:mt-[3.67936925vw] " >
                        <div class={`col ${(currentLeft === smLeft) ? 'hiddenDown' : ''} md:hiddenRight ${(meVisible && (currentLeft === smLeft)) ? 'showY' : ''} ${meVisible ? 'md:showX' : ''} pt-[10.628019323671497vw] md:pt-[2.89093298292vw]`} >
                            <h3 class={`bulletTitle text-center md:text-start font-medium`} >
                                Hello! my name’s Zaid Fatma
                            </h3>
                            <p class="text w-full md:w-[42.772667vw] mt-[7.729468599033816vw] md:mt-[2.3653088042049935vw] ">
                                I am from Algeria, exactly from Tiaret, where I grew up untill the end of 1999, at that year I left Algeria and went to settle down in France, city of Toulouse.
                                <br /><br />
                                So far State employee in preparatory schools For children from 3 to 6 years old, all while being an investor and marketer for the UAE society.
                ...
                <section ref={social} id="Contact" class="col items-center md:gap-[6.57030223390276vw] gap-[15.458937198067632vw]">
                    ...
                    <div class={`row md:gap-[13.14060446780552vw] flex-wrap gap-[15.458937198067632vw] md:h-auto h-[42.7536231884058vw] w-[42.51207729468599vw] md:w-auto justify-between`}>
                        ...
                        <a href='https://wa.me/33771240382?text=Hello%20I%20would%20like%20to%20know%20more%20about%20ZENIQ%20and%20its%20token%20ZENIQ%20COIN' target='_blank' rel="noreferrer" id="whatsapp" >
                        ...
                        <a id="telegram" href="https://t.me/+33771240382?text=Hello%20I%20would%20like%20to%20know%20more%20about%20ZENIQ%20and%20its%20token%20ZENIQ%20COIN" >
