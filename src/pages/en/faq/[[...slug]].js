...
const Faq = () => {
    ...
    const faq = [
        {
            question: "What is special about ZENIQ Technologies?",
            answer: "ZENIQ Technologies provides a unique ecosystem to its customers, which will connect your crypto wallet to an IBAN account in a seamless way. You can store and access all of your fiat and crypto assets in the ecosystem through your ZENIQ HUB which is placed in the security of your home."
        },
        {
            question: "Who is ZENIQ for?",
            answer: "Simple and clear: for everyone!"
        },
        {
            question: "How do I order a ZENIQ HUB?",
            answer: "The ZENIQ HUB can be conveniently purchased through licensed and certified distribution partners only. All required information is collected through the ordering process at the partner‘s websites. Please contact our partner SAFIR Global DMCC: sales@safir.com"
        },
        {
            question: "Who is behind ZENIQ?",
            answer: "A team of crypto and fin-technology enthusiasts who see the added value of Blockchain technology in everyday life, that have been dealing with the blockchain for about ten years and originally come from various businesses and expertises that complement each other. with the aim to mainstream the usage of crypto technology in any business field."
        },
        {
            question: "What is the ZENIQ Coin?",
            answer: "The ZENIQ Coin is the new coin that was created with the ZENIQ blockchain to support the financial ecosystem as a medium for profit sharing through the added value generated by the ZENIQ Exchange. At the same time, the ZENIQ Coin will also be used in the future for realizing real and profitable ZENIQ projects, with an additional listing on other international exchange platforms. The expected value development of the ZENIQ coin is thus not only linked to a profit sharing of the ZENIQ Exchange, but also to the future ZENIQ projects and as a means of payment for products and services within the ZENIQ ecosystem"
        }
    ]
            ...
            <header class="smFaq md:mdFaq grid place-items-center">
                <div className=" justify-center items-center col gap-[1.9053876478318004vw] " >
                    ...
                    <p class="heroDescription text-center">
                        Find a list of the most asked questions as well as their answers!
                    </p>
                </div>
                ...
                <section ref={tutos} id="tutorials" class="col items-center" >
                    ...
                    <div id="videos" class="col items-center gap-[10.144927536231885vw] md:gap-0 md:row w-full pt-[10.144927536231885VW] md:pt-[6.57030223390276vw] justify-between">
                        ...
                        <div class={` tuto cursor-pointer ${viewPort ? 'hiddenDown' : ''} md:hiddenLeft ${tutosVisible && viewPort ? 'showY' : ''} ${tutosVisible ? 'md:showX' : ''} delay-[400ms]`} onClick={() => {
                            ...
                            <div class="description">
                                <h3 class="descriptionTitle">
                                    Where do you find your minted coins
                                </h3>
                            </div>
                        </div>
                    </div>
