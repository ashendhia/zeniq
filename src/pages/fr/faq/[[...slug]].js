...
const Faq = () => {
    ...
    const faq = [
        {
            question: "Quoi de spécial dans les technologies de ZENIQ?",
            answer: "Les Technologies de Zeniq fournissent un écosystème unique à ses clients, qui connecte votre portefeuille crypto à un compte IBAN de manière transparente. Vous pouvez stocker et accéder à tous vos actifs fiat et crypto dans l'écosystème via votre ZENIQ HUB qui est placé dans la sécurité de votre maison."
        },
        {
            question: "A qui s'adresse ZENIQ ?",
            answer: "Tout simplement: Tout le monde!"
        },
        {
            question: "Comment puis-je commander un ZENIQ HUB ?",
            answer: "Le HUB ZENIQ ne peut être acheté que par l'intermédiaire de partenaires de distribution agréés et certifiés. Toutes les informations requises sont collectées via le processus de commande sur les sites Web des partenaires. Veuillez contacter notre partenaire SAFIR Global DMCC : sales@safir.com"
        },
        {
            question: "Qui est derrière ZENIQ ?",
            answer: "Une équipe de passionnés de la crypto et de la fin-technologie qui voient la valeur ajoutée de la technologie Blockchain au quotidien, avec une dizaine d'années comme experience en Blockcahain et qui sont à l'origine issus de métiers et d'expertises variés qui se complètent. dans le but d'intégrer l'utilisation de la technologie cryptographique dans n'importe quel domaine d'activité."
        },
        {
            question: "Qu'est-ce que le ZENIQ Coin ?",
            answer: "ZENIQ Coin est la nouvelle monnaie qui a été créée avec la blockchain ZENIQ pour soutenir l'écosystème financier en tant que moyen de partage des bénéfices grâce à la valeur ajoutée générée par ZENIQ Exchange. Dans le même temps, le ZENIQ Coin sera également utilisé à l'avenir pour réaliser des projets ZENIQ réels et rentables, avec une cotation supplémentaire sur d'autres plateformes d'échange internationales. L'évolution attendue de la valeur de la pièce ZENIQ n'est donc pas seulement liée à une participation aux bénéfices de ZENIQ Exchange, mais également aux futurs projets ZENIQ et en tant que moyen de paiement pour les produits et services au sein de l'écosystème ZENIQ."
        }
    ]
        ...
        <main>
            <header class="smFaq md:mdFaq grid place-items-center">
                <div className=" justify-center items-center col gap-[1.9053876478318004vw] " >
                    <h1 class="faqBigTitle">
                        Questions posées fréquemment
                    </h1>
                    <p class="heroDescription text-center">
                        Retrouvez une liste des questions les plus posées ainsi que leurs réponses!
                    </p>
                </div>
            ...
            <div class="faq">
                <section id="faq" class="faqFlex md:h-[48vw]">
                    {faq.map(((qa, i) => {
                        return (
                            <div key={i} accessKey={i} ref={node => handleRef(node, i)} class={`qA hiddenDown ${qaVisible[i].visible && qaVisible[i].triggerOnce === 1 ? 'showY' : ''}`}>
                                <h3 class="bulletTitle font-medium">
                                    {qa.question}
                                </h3>
                ...
                <section ref={tutos} id="tutorials" class="col items-center" >
                    <h2 class="title">
                        Comment utiliser votre compte SAFIR
                    </h2>
                    <div id="videos" class="col items-center gap-[10.144927536231885vw] md:gap-0 md:row w-full pt-[10.144927536231885VW] md:pt-[6.57030223390276vw] justify-between">
                        ...
                        <div class={` tuto cursor-pointer ${viewPort ? 'hiddenDown' : ''} md:hiddenLeft ${tutosVisible && viewPort ? 'showY' : ''} ${tutosVisible ? 'md:showX' : ''} delay-[400ms]`} onClick={() => {
                            ...
                            <div class="description">
                                <h3 class="descriptionTitle">
                                    Où trouvez-vous vos pièces monnayées
                                </h3>
                            </div>
                        </div>
                    </div>
